        ...
        return (
            <div className="auth-wrapper">
                ...
                <div className="right">
                    ...
                    <div className='sub-header'>We help you crack interviews</div>
                    {page}
                    <div className="new" onClick={this.changeTab}>{this.state.tab === 'signin' ? 'New to Crack It? Sign up here' : 'Already have an account with us? Sign in'}</div>
                </div>
            </div>
        )
    }
